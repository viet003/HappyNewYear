...
(function () {
  var animation = {
    ...
    render: function () {
      ...
      // Kiểm tra nếu đếm ngược = 0
      if (period.days === 0 && period.hours === 0 && period.minutes === 0 && period.seconds === 0) {
        // Chuyển trang
        window.location.href = "./main.html"; // Thay URL bằng trang bạn muốn chuyển
        return; // Ngừng render
      }
    }
  };
